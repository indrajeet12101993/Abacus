 ...
 */
public class DecimalTimerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_decimal_timer, container, false);
                        ...
                        activity.runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                             //   int randomNum = rn.nextInt((max - min) + 1) + min;
                                int randomNum = (rn.nextInt(max ) - min);

                                Float rfraction= randomNum/10.0f;

                                t1.speak( String.valueOf(rfraction), TextToSpeech.QUEUE_FLUSH, null);
                                tv_sum.setText(String.valueOf(rfraction));
                                mResult.add(rfraction);
        ...
        btn_check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!uservalue.isEmpty()){
                    Float integerresult = Float.parseFloat(uservalue);
