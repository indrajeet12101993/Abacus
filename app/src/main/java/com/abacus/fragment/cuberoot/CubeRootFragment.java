...
import com.abacus.R;
import com.abacus.fragment.squareroot.SquareRootTimerFragment;
import com.abacus.utils.UtilityMethods;
import com.abacus.viewmodel.DataViewModel;

public class CubeRootFragment extends Fragment {
    EditText et_digits;
    EditText et_sum;
    EditText et_time;
    Button btn_start;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_cube_root, container, false);
        ...
        btn_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!validation()){
                    ...
                    replaceFragment(new CubeRootTimerFragment() );
